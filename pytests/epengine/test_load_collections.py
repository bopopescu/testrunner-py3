...
class basic_collections(BaseTestCase):
    ...
    def test_load_collection(self):
        ...
        # self._load_all_buckets(self.main, gen_create, "delete", 0)
        # self._verify_stats_all_buckets(self.servers[:self.nodes_init])
        #
        # self._load_all_buckets(self.main, gen_create, "create", 0)
        # # Add a node, rebalance and verify data
        # self._load_all_buckets(self.main, gen_create, "read", 0)
        # self._verify_stats_all_buckets(self.servers[:self.nodes_init])
        #
        # self._load_all_buckets(self.main, gen_create, "update", 0)
        # self._verify_stats_all_buckets(self.servers[:self.nodes_init])
        # self._verify_all_buckets(self.main)
